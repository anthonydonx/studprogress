...
$.ajax({
    ...
    for(i=0; i<stid.Data.length; i++){
      ...
      $('#studentsid').append($("<option></option>")
            .attr("value",stid.Data[i].Students_topic.Studentsid)
            .text(stid.Data[i].Students_topic.Studentsid));
...
$.ajax({
    ...
    for(i=0; i<sti.Data.length; i++){
      ...
      $('#title').append($("<option></option>")
            .attr("value",sti.Data[i].Students_topic.Topicstitle)
            .text(sti.Data[i].Students_topic.Topicstitle));
